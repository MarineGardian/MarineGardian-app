...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Tests création de packeges ",
    Description = "tester la création de packages.",
    `Authors@R` = c(
      person("Leila", "ROUABHI", email = "rouabhi-leila@hotmail.fr", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Leila ROUABHI")
```
